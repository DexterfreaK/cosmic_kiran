...
G4VPhysicalVolume* DetectorConstruction::ConstructCalorimeter()
{
  ...
  calorThickness = moduleThickness * nbOfModules + moduleSpacing * nbOfModules;
...
void DetectorConstruction::PrintCalorParameters()
{
  ...
  G4cout << "\n ---> A Layer includes " << nbOfFibers << " fibers of " << fiberMat->GetName();
  ...
  G4cout << "\n ---> The milled Layer is " << G4BestUnit(milledLayer, "Length") << " thickness of "
         << absorberMat->GetName();
